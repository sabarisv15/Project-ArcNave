...
| `capability_explain`             | R     | —     | User asks _why_ a capability behaves a certain way / is restricted.                                  |
...
**Disambiguation:** anything that changes a student's _status_ is `S`, not `update_profile`.
...
| Tool                                | Class | Use when                                                      |
| ----------------------------------- | ----- | ------------------------------------------------------------- |
| `ai_memory_consent_status`          | R     | _*Gate. Call before any other ai_memory_* write._*            |
