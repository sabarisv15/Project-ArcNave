...
// signing... policy checks"). Same mechanism/reasoning as
// ../../backend/scripts/audit-policy-gate.js — see that file's header
// comment. Duplicated rather than shared because there is no
// cross-package tooling module in this repo yet (5.13, multi-package
// workspace tooling, is a separate unscoped P5 item).
//
