...
export function ScopeToggle({ mode, onMode }) {
  const base =
    'w-[92px] h-[28px] rounded-[8px] border-0 text-[12.5px] cursor-pointer transition-colors duration-200';
  return (
    <div role="group" aria-label="Composer scope" className="flex items-center gap-[2px] p-[2px] bg-tint2 rounded-[10px]">
