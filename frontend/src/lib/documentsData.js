...
export const INSTITUTIONAL_DOCS = [
  inst(
    'inst-01',
    'Semester fee circular — Odd 2026-27.pdf',
    'application/pdf',
    'Circulars',
    'Administration',
    3,
  ...
  inst(
    'inst-02',
    'Attendance policy — revision 4.pdf',
    'application/pdf',
    'Academic policies',
    'Academic office',
    11,
  ...
  inst(
    'inst-03',
    'Evaluation and re-evaluation policy.pdf',
    'application/pdf',
    'Academic policies',
    'Academic office',
    26,
  ...
  inst(
    'inst-04',
    'CSE department notice — lab rota.pdf',
    'application/pdf',
    'Department notices',
    'Computer Science',
    1,
  ...
  inst(
    'inst-05',
    'Department meeting minutes — 02/08/2026.docx',
  ...
  inst(
    'inst-06',
    'Approved timetable — Odd 2026-27 (Revised v2).pdf',
    'application/pdf',
    'Timetables',
    'Academic office',
    5,
  ...
  inst(
    'inst-09',
    'B.Sc Computer Science — syllabus 2026 regulation.pdf',
    'application/pdf',
    'Curriculum documents',
    'Computer Science',
    61,
  ...
  inst(
    'inst-10',
    'Course outcome mapping template.xlsx',
  ...
  inst(
    'inst-11',
    'Question paper format — internal exams.docx',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    'Institutional templates',
    'Academic office',
    34,
  ...
  inst(
    'inst-13',
    'Internal assessment II — instruction circular.pdf',
    'application/pdf',
    'Circulars',
    'Academic office',
    2,
  ...
  inst(
    'inst-14',
    'Anti-ragging committee notice.pdf',
    'application/pdf',
    'Department notices',
    'Administration',
    19,
  ...
  inst(
    'inst-15',
    'Practical record format — CS labs.docx',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    'Institutional templates',
    'Computer Science',
    40,
  ...
  inst(
    'inst-16',
    'Faculty meeting minutes — 21/07/2026.docx',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    'Meeting minutes',
    'Academic office',
    23,
...
export function initialPersonalNodes() {
  return [
    ...
    file(
      'p-f02',
      'p-sem3',
      'Process scheduling worked examples.docx',
      'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
      143_000,
      2,
    ),
    ...
    file(
      'p-f04',
      'p-sem5',
      'DBMS — normalisation slides.pptx',
