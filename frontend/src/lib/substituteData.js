...
export const COLLEAGUES = [
  {
    ...
    coverEligible: true,
    busy: { mon: [1, 4, 6], tue: [2, 3], wed: [1, 5, 8], thu: [3, 4], fri: [2, 7] },
  },
  {
    id: 'st-02',
    name: 'Prof. Girish Menon',
    designation: 'Assistant Professor',
    dept: 'Computer Science',
    coverEligible: true,
    busy: { mon: [2, 3, 7], tue: [1, 5], wed: [3, 4], thu: [1, 6], fri: [3, 8] },
  },
  {
    id: 'st-03',
    name: 'Dr. Nandita Roy',
    ...
    dept: 'Computer Science',
    coverEligible: true,
    busy: { mon: [1, 2, 5], tue: [4, 6], wed: [2, 7], thu: [2, 5], fri: [1, 4] },
  },
  {
    id: 'st-04',
    name: 'Prof. Ashok Pillai',
    designation: 'Assistant Professor',
    dept: 'Computer Science',
    coverEligible: true,
    busy: { mon: [3, 8], tue: [7, 8], wed: [6], thu: [7, 8], fri: [5, 6] },
  },
  {
    id: 'st-05',
    name: 'Ms. Divya Raghavan',
    designation: 'Assistant Professor',
    dept: 'Computer Science',
    coverEligible: true,
    busy: { mon: [5, 6], tue: [1, 2, 3], wed: [4, 5], thu: [1, 2], fri: [6, 7] },
  },
  {
    id: 'st-06',
  ...
  },
  {
    ...
    dept: 'Electronics',
    coverEligible: true,
    busy: { mon: [1, 2], tue: [3, 4], wed: [5, 6], thu: [7, 8], fri: [1, 2] },
  },
  {
    id: 'st-08',
    ...
    dept: 'Electronics',
    coverEligible: true,
    busy: { mon: [4, 5], tue: [6, 7], wed: [1, 8], thu: [3, 4], fri: [5, 8] },
  },
];
...
export const INCOMING_REQUESTS = [
  ...
  },
  {
    ...
    resolvedAt: dayKeyOffset(-2),
    periodId: 's-locked-today',
  },
  {
    id: 'req-in-3',
    direction: 'incoming',
    fromStaff: 'Dr. Nandita Roy',
    fromStaffId: 'st-03',
    recipientMode: 'available',
    toStaffId: null,
    recipientCount: 3,
    dateKey: dayKeyOffset(1),
    scope: 'day',
    slots: [
  ...
  },
  {
    id: 'req-in-4',
    direction: 'incoming',
    fromStaff: 'Prof. Ashok Pillai',
    fromStaffId: 'st-04',
    recipientMode: 'specific',
    toStaffId: ME.id,
    recipientCount: 1,
    dateKey: dayKeyOffset(2),
    scope: 'period',
  ...
  },
  {
    id: 'req-in-5',
    direction: 'incoming',
    fromStaff: 'Dr. Meenakshi Sundaram',
    fromStaffId: 'st-07',
    recipientMode: 'available',
    toStaffId: null,
    recipientCount: 5,
    dateKey: dayKeyOffset(-4),
    scope: 'period',
    slots: [slotRef(5, 'Signals & Systems', 'III B.Sc ECE — A')],
    reason: 'Personal leave.',
    status: 'declined',
    createdAt: dayKeyOffset(-6),
    resolvedAt: dayKeyOffset(-5),
    periodId: null,
  },
];
...
export const MY_REQUESTS = [
  ...
  },
  {
    ...
    resolvedAt: dayKeyOffset(-4),
    acceptedBy: 'Dr. Nandita Roy',
    periodId: null,
  },
  {
    id: 'req-out-3',
    ...
    toStaffId: 'st-02',
    recipientCount: 1,
    dateKey: dayKeyOffset(-8),
    scope: 'period',
    slots: [slotRef(6, 'Data Structures Lab', 'II B.Sc CS — A')],
    reason: '',
    status: 'declined',
    createdAt: dayKeyOffset(-10),
    resolvedAt: dayKeyOffset(-9),
    acceptedBy: null,
    periodId: null,
  },
  {
    ...
    toStaffId: null,
    recipientCount: 3,
    dateKey: dayKeyOffset(-14),
    scope: 'period',
    slots: [slotRef(8, 'Discrete Mathematics', 'II B.Sc CS — C')],
    reason: 'Conference travel.',
    status: 'expired',
    createdAt: dayKeyOffset(-17),
    resolvedAt: dayKeyOffset(-15),
    acceptedBy: null,
    periodId: null,
  },
];
...
export const SUBSTITUTE_LOG_HISTORY = [
  {
    id: 'sublog-1',
    periodId: 's-old-submitted',
    dateKey: dayKeyOffset(-3),
    slot: slotRef(3, 'Computer Organization', 'II B.Sc CS — C'),
  ...
  },
  {
    id: 'sublog-2',
    periodId: null,
    dateKey: dayKeyOffset(-9),
    slot: slotRef(2, 'Operating Systems', 'II B.Sc CS — B'),
  ...
  },
  {
    id: 'sublog-3',
    periodId: null,
    dateKey: dayKeyOffset(-11),
    slot: slotRef(5, 'Computer Networks', 'III B.Sc CS — B'),
  ...
  },
  {
    id: 'sublog-4',
    periodId: null,
    dateKey: dayKeyOffset(-16),
    slot: slotRef(7, 'Database Systems', 'III B.Sc CS — A'),
    originalStaff: 'Dr. Nandita Roy',
    attendanceState: 'window_closed',
    acknowledged: true,
  },
  {
    id: 'sublog-5',
    periodId: null,
    dateKey: dayKeyOffset(-22),
    slot: slotRef(1, 'Digital Circuits', 'II B.Sc ECE — B'),
