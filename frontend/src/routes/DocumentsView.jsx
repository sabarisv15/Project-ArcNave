    ...
    <DocumentsProvider>
      <div className="flex-1 min-h-0 flex flex-col overflow-hidden animate-viewIn">
        <div className="flex-none px-[24px] pt-[18px] border-b border-line">
          <div role="tablist" aria-label="Document types" className="flex items-center gap-[30px] overflow-x-auto overflow-y-hidden scroll-quiet">
            {TABS.map(({ key, label }) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active ? 'border-accent text-ink font-[600]' : 'border-transparent text-ink-soft font-[500] hover:text-ink'
                  )}
                >
                  {label}
                </button>
